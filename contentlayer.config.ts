  ...
  computedFields: {
    ...
    structuredData: {
      ...
      resolve: (doc) => ({
        ...
        image: doc.images ? doc.images[0] : metadata.socialBanner,
        url: `${metadata.siteUrl}/${doc._raw.flattenedPath}`,
        author: doc.authors,
      }),
    },
  },
...
export const AuthorType = defineDocumentType(() => ({
  name: 'Authors',
...
export default makeSource({
  contentDirPath: 'data',
  documentTypes: [BlogType, AuthorType],
  mdx: {
    cwd: process.cwd(),
    remarkPlugins: [
      remarkExtractFrontmatter,
